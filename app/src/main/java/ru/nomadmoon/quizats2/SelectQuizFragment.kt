 ...
 * [SelectQuizFragment.OnListFragmentInteractionListener] interface.
 */
class SelectQuizFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.quiz_item_list, container, false)
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = QuizListRecyclerViewAdapter(DummyContent.ITEMS, listener)
            }
        }
        return view
    }
